...
public class NewsController {
	...
	public String ajax(ModelMap model, String flightno, HttpServletResponse response) {
		...
		/*
		 * News news = new News(); news.setContent("aaa啊啊啊啊");
		 * news.setTitle("ddd");
		 */
	...
	@RequestMapping("")
	public ModelAndView list(HttpServletRequest request, Integer departurecity, Integer arrivalcity) {
		ModelAndView view = new ModelAndView();
		/*List<News> list = flightService.findAllWhere(departurecity, arrivalcity);
		List<City> cityAll = cityService.selectAll();
		view.addObject("list", list);
		view.addObject("cityAll", cityAll);*/

		view.setViewName("/flight/flight_list");
		return view;
	}
	...
	public NewsController() {
		...
		System.out.println("┃　　　　　　 ┃");
		System.out.println("┗━┓　　　 ┏━┛");
		System.out.println("　  ┃　　     ┃神兽保佑");
		System.out.println("　  ┃　　　 ┃代码无BUG");
		System.out.println("　  ┃　　　 ┗━━━┓");
		System.out.println("　  ┃　　　　 　　┣┓");
		System.out.println("　  ┃　　　　 　　┏┛");
		System.out.println("　  ┗┓┓┏━┳┓ ┏┛");
